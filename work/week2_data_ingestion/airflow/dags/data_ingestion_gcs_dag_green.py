...
BUCKET_FOLDER="raw_green"


date_param = '{{logical_date.strftime("%Y-%m")}}'
dataset_file = f"green_tripdata_{date_param}.csv"
...
with DAG(
    ...
    # download_dataset_task >> format_to_parquet_task >> local_to_gcs_task >> bigquery_external_table_task >> cleanup
